...
class CreateBookRequest extends FormRequest
{
    ...
    {
        return [
            'title' => ['description' => 'Book title', 'example' => 'The Great Novel'],
            'category_id' => ['description' => 'Category id', 'example' => 1],
            'isbn' => ['description' => 'Unique ISBN', 'example' => '9781234567897'],
            'price' => ['description' => 'Book price', 'example' => 9.99],
            'publish_year' => ['description' => 'Year of publication', 'example' => 2023],
            'stock' => ['description' => 'Available stock count', 'example' => 10],
